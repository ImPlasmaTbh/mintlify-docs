...
You can hear these announcement at these stages of flight:

- Boarding (Boarding music, cabin crew announcement, captain announcement)

  <Note>
    We offer the entire collection of Emirates' Boarding Music! We have over **67 different tracks**, totalling more than **200 unique songs** that can play during boarding! 

    \
    Currently, Emirates Virtual is the only Virtual Airline that offers such a vast variety of boarding music, integrated directly into our ACARS client!
  </Note>
...
To enable them: **Open Pegasus -\> Navigate to Settings at the top right -\> Navigate to Sound using the sidebar -\> set "Announcements" to "Airline Only"**.
